...
export async function generateMetadata({ params }: Props) {
  ...
  if (!h) return { title: "Hop not found — WortHogg" };
  return {
    title: `${h.name} — WortHogg`,
    description:
      h.description ??
      `${h.name}: alpha and beta acids, oil composition and substitutes, checked against the merchant sheet each figure came from.`,
  };
}
